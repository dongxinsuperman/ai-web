...
- 浏览器 Agent 轻量改造方案：[`docs/浏览器Agent轻量改造方案.md`](./docs/浏览器Agent轻量改造方案.md)
- 浏览器 Agent 实施蓝图：[`docs/浏览器Agent实施蓝图.md`](./docs/浏览器Agent实施蓝图.md)
- 浏览器 Agent 执行环境安装：[`docs/浏览器Agent执行环境安装.md`](./docs/浏览器Agent执行环境安装.md)
