...
Vue 3 + Vite + Element Plus 实现的维护台：提交记录、执行报告、素材、站点免登和 Browser Agent 节点配置。

项目整体的启动方式与架构见根目录 [README](../README.md) 和 [快速开始](../docs/快速开始.md)。
...
- **配置**：热调 Browser Agent 节点容量和有头/无头模式。
